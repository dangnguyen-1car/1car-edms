...
CREATE TABLE IF NOT EXISTS audit_logs_temp_migration_003 (
    ...
    CHECK (action IN (
        ...
        'DOCUMENTS_SEARCHED', 'SEARCH_DOCUMENTS',
        'DOCUMENT_CODE_SUGGESTED', -- <<< ĐÃ THÊM VÀO ĐÂY
...
ALTER TABLE document_permissions ADD COLUMN IF NOT EXISTS revoked_by INTEGER;
ALTER TABLE document_permissions ADD COLUMN IF NOT EXISTS revoked_at DATETIME;
