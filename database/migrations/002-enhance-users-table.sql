...
SELECT
    ...
    COUNT(CASE WHEN last_login >= date('now', '-30 days', 'localtime') THEN 1 END) as recent_active_users,
...
VALUES ('002', 'Enhance users table with security and profile fields', datetime('now', 'localtime'));