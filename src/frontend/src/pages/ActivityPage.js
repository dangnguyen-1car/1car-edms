...
/**
 * =================================================================
 * EDMS 1CAR - Archive Page (Admin Only - ESLint Hooks Fixed)
...
function ArchivePage() {
  ...
  const restoreDocumentMutation = useMutation(
    ({ documentId, newStatus }) => documentService.updateDocumentStatus(documentId, newStatus, 'Khôi phục từ lưu trữ bởi Admin'),
    {
      ...
      onError: (err) => { // Sửa tên biến error
  ...
  if (!canFetchArchived) { // Sử dụng biến đã tính toán
    return (
      ...
      <div className="max-w-full mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="card">
          <div className="card-body p-0">
            ...
            ) : isError && !documentsData ? ( // Chỉ hiển thị lỗi chính nếu không có data cache
                      ...
                      <tr key={doc.id}>
                        ...
                        <td className="text-center">
                          <button onClick={() => handleRestoreDocument(doc)}
                                  className="btn-icon text-blue-600 hover:text-blue-700 hover:bg-blue-50 p-1.5 rounded-md" // Thay đổi màu nút khôi phục
