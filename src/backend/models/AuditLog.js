...
class AuditLog {
  ...
  static get VALID_RESOURCE_TYPES () {
    const resourceTypes = new Set([
      'user', 'document', 'version', 'file', 'workflow', 'permission',
      'system', 'audit_log', 'auth', 'permission_check', 'permission_grant',
      'permission_revoke', 'effective_permission_query', 'system_settings',
      'workflow_task', 'workflow_dashboard', 'upload', 'search_suggestion',
      'document_statistics', 'documents_due_review', 'search_filters',
      'locked_users', 'system_stats', 'department_stats', 'user_stats'
    ])
