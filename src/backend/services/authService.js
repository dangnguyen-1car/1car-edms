  ...
  static async updateProfile (userId, updateData, context = {}) {
    try {
      ...
      for (const field of allowedFieldsToUpdate) {
        if (Object.prototype.hasOwnProperty.call(updateData, field) && updateData[field] !== user[field]) {
      ...
      await createAuditLog({
        ...
        details: {
          ...
          oldValues: allowedFieldsToUpdate.reduce((acc, field) => {
            if (Object.prototype.hasOwnProperty.call(dataToActuallyUpdate, field)) acc[field] = user[field]
            return acc
          }, {}),
